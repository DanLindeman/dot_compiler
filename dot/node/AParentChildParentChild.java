...
public final class AParentChildParentChild extends PParentChild
{
    private TId _parent_;
    private TId _child_;

    public AParentChildParentChild()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParentChildParentChild(
    ...
    {
        ((Analysis) sw).caseAParentChildParentChild(this);
    }
