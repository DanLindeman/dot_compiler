...
public final class ACreateParentChildNodes extends PCreateParentChildNodes
{
    private TId _parent_;
    private TId _child_;

    public ACreateParentChildNodes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACreateParentChildNodes(
    ...
    {
        ((Analysis) sw).caseACreateParentChildNodes(this);
    }
